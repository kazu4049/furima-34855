...
ActiveRecord::Schema.define(version: 2021_04_12_072641) do
  ...
  create_table "aderesses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  add_foreign_key "aderesses", "records"
